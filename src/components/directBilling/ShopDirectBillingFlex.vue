<template>
    <div class="flex flex-row w-full p-8 justify-content-center align-items-center gap-8">
        <div class="flex w-6 flex-column">
            <span 
                class="text-green-700 w-5rem text-center font-semibold bg-green-50 border-none border-round-3xl px-3 py-2">NEW</span>
            <div class="text-3xl flex-wrap text-900 font-medium mt-3">Maximize your benefits with online Direct Billing!</div>
            <div class="mt-3">
                <ul class="list-none">
        ...
        <div class="flex w-4 flex-column">
