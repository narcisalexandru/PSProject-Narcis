  ...
  state: () => ({
    optionSteps: {
      ...
      readers_options: [
        {
          id: "simple_readers",
          label: "Simple Readers",
          description: "Basic magnification for reading.",
          image: "/simple_readers.svg",
          next: "non_prescription_options",
        },
        {
          id: "prescription_readers",
          label: "Prescription Readers",
          description: "Readers with prescription.",
          image: "/prescription_readers.svg",
          next: "readers_pds",
        },
      ],
      readers_pds: [],
    ...
    titles: {
      ...
      progressives_pds: "Enter your pupilary distance",
      readers_options: "Choose your reader type",
      readers_pds: "Enter your pupilary distance",
